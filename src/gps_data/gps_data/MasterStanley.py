...
class StanleyController():
    ...
    def implementation(self):
        gps_df = pd.read.csv("/home/tera/ros2_ws2/src/gps_data/gps_data/gps_data_tera_fresh1.csv")
        ...
        target_position = self.get_target_location()[0]
        ...
        path_yaw = self.path_yaws()

        def map_range(x, in_min, in_max, out_min, out_max):
            return (x - in_min) * (out_max - out_min) // (in_max - in_min) + out_min
        
        self.adj_steering_command = int(map_range(self.steering_command, 45, -45, 50, 600))
